window.onload = () => {
  ...
  var canvas = document.getElementById('particlesNodeAnimation');
  ...
  function fix_dpi() {
    ...
    let style_height = canvas.parentElement.offsetHeight;
    let style_width = canvas.parentElement.offsetWidth;
    //scale the canvas
  ...
  particles = [],
  couleurs   = ["#C2DED1", "#ECE5C7", "#CDC2AE","#354259"];
  function Particle(){
